...
export default function Main() {
  return (
    <div>
      <div className="grid grid-cols-6 mt-10 gap-8 sm:px-20">
        <div className="col-span-3 bg-gradient-to-r from-[#002E4A] to-[#0061AD] p-10 text-white relative">
          ...
          <div className="flex w-full h-full" >
            <div className="mt-auto">
              <div className="text-6xl">ELKE COMPANY</div>
      ...
      <div className="flex gap-8 mt-8 px-20">
        <div className="flex w-full p-10 col-span-4 border border-[#F0F0F0] bg-[url(/Vector-map.png)] bg-no-repeat bg-right">
          <div className="mt-auto">
            ...
            <div className="text-5xl mt-3">Наши клиенты</div>
      ...
      <div className="mt-5 text-center">
        <div className="text-[#0061AD] text-xl">О компании</div>
